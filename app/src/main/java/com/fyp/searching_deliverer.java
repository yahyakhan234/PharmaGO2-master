...
public class searching_deliverer extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Timer().schedule(new TimerTask(){
            public void run() {
                startActivity(new Intent(searching_deliverer.this, order_accepted.class));
                finish();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(sydney).title("Requesting Nearby Pharmacists"));
